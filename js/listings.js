...
function searchListings() {
    ...
    if (searchInputElement === undefined || searchInputElement.value === '' || searchInputElement.value.length < 3) {
        ...
        for (const data of listingsData) {
            if (data.title.toLowerCase().includes(searchInputElement.value.toLowerCase()) || data.description.toLowerCase().includes(searchInputElement.value.toLowerCase()) || data.location.toLowerCase().includes(searchInputElement.value.toLowerCase())) {
